...
class MemberMixin:
    ...
    def _eval_list_member(self, obj: list, member: str) -> Any:
        ...
        if member == 'mapCartesian': return ('builtin', lambda args, ctx: [[a, b] for a in obj for b in args[0]])
