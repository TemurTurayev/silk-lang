...
class MemberMixin:
    ...
    def _eval_list_member(self, obj: list, member: str) -> Any:
        ...
        if member == 'mapNths': return ('builtin', lambda args, ctx: obj[::int(args[0])])
