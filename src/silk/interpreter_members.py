...
class MemberMixin:
    ...
    def _eval_list_member(self, obj: list, member: str) -> Any:
        ...
        if member == 'mapWindows': return ('builtin', lambda args, ctx: (lambda n: [obj[i:i+n] for i in range(len(obj)-n+1)])(int(args[0])))
