...
class MemberMixin:
    ...
    def _eval_number_member(self, obj: int | float, member: str) -> Any:
        ...
        _simple = {
            ...
            'digitMirror': lambda: int(str(abs(int(obj))) + str(abs(int(obj)))[::-1]),
        }
